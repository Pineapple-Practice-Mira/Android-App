...
object EmotionList {
    val emotions = listOf(
        ...
        Emotion(id = 5, nameResId = R.string.sympathy, type = Emotion.Type.POSITIVE, emojiResId = R.drawable.emotion_sympathy),
        ...
        Emotion(id = 10, nameResId = R.string.anxiety, type = Emotion.Type.NEGATIVE, emojiResId = R.drawable.emotion_anxiety),
